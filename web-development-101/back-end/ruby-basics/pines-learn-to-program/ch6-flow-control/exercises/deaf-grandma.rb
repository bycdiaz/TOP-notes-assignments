...
# she should respond with  HUH?!  SPEAK UP, SONNY!, unless you shout it (type in all 
# capitals). If you shout, she can hear you (or at least she thinks so) and yells 
# back, NO, NOT SINCE 1938! To make your program really believable, have grandma 
...
# random number generator at the end of the methods chapter.) You can't stop talking 
...
while init_grandma != 'BYE BYE BYE'
  init_grandma = gets.chomp
  if (init_grandma == init_grandma.upcase)
